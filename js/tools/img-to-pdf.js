// ==========================================
    ...
    function renderPreview() {
      ...
      // Optimized: Using DocumentFragment for better DOM rendering performance
      ...
      // Append all items at once to reduce DOM reflows
    ...
    ["dragenter", "dragover", "dragleave", "drop"].forEach(eventName => {
      previewBox.addEventListener(eventName, e => {
        ...
        e.preventDefault();
        e.stopPropagation();
      }, { passive: false }); // Needs to preventDefault, so passive is false here, but grouped efficiently
    });
    ...
    }, { passive: true }); // Passive true improves scroll rendering on mobile
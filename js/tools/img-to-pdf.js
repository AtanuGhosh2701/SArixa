    ...
    if (isBatchMode) {
      ...
      outputBox.innerHTML = `
        <div class="success-card">
            ...
            <p style="color: #b2ebf2; font-size: 0.95rem;">All individual PDF files have been generated and downloaded successfully.</p>
            <div class="stats-grid">
                <div class="stat-box">
                    <div class="stat-value highlight" id="animTotalFiles">0</div>
      ...
      outputBox.innerHTML = `
        <div class="success-card">
            ...
            <div class="stats-grid">
                ...
                <div class="stat-box">
                    <div class="stat-value" id="animPdfSize">0</div>
                    <div class="stat-label">File Size</div>
                </div>
            </div>
        </div>
      `;
      animateValue("animTotalPages", 0, images.length, 1500, "");
      animateValue("animPdfSize", 0, finalMb, 1500, "MB", true);
  ...
  if (isPreviewOpen) {
    ...
    outputBox.innerHTML = `
      <div class="success-card">
          ...
          <div class="stats-grid">
              <div class="stat-box">
                  <div class="stat-value highlight">${images.length}</div>
                  <div class="stat-label">Total Images</div>
              </div>
              <div class="stat-box">
                  <div class="stat-value">${finalMb.toFixed(2)} <span style='font-size:0.5em'>MB</span></div>
                  <div class="stat-label">File Size</div>
              </div>
          </div>
      </div>
